...
static float bx = 0.0, by = 0.0, isbaby = 0 ;
static float dolnay = 0, glUp = 1, angle = 0, step = 0, stepx = 0, stepy = 0, countdolna = 0 ;
static float cloudleftx = 0, cloudmiddlex = 0, cloudrightx = 0, cloudrightupx = 0 ;
...
void slide()
{
    ...
    glPushMatrix();
        ...
        glPushMatrix();     // Bottom side stand
            glColor3f(0.54,0.396,0.031);
            glBegin(GL_QUADS);
            glVertex2d(3,0);
            glVertex2d(2.7,0);
